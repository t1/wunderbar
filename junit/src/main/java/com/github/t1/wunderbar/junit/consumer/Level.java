...
public enum Level {
     ...
     * by default a <code>bar</code> file and optionally an OpenAPI JSON file.
    ...
    /**
     * Call a pre-installed <code>wunderbar-mock-server</code>.
     * How you deploy it and how you configure your service to call the mock-server is out of the scope of WunderBar.
     * <p>
     * Use the {@link Service#endpoint()} to configure where the mock-service or real service runs.
     * <p>
     * You <em>can</em> use this also to explore the behavior of a real service, but it won't understand the calls
     * that are generated by <code>given</code> calls.
     * <p>
