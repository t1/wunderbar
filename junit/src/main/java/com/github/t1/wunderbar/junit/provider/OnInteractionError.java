 ...
 * <ul>
 * <li>{@link com.github.t1.wunderbar.junit.http.HttpServerInteraction HttpServerInteraction}: the expected request and response
 * <li>{@link com.github.t1.wunderbar.junit.http.HttpServerResponse HttpServerResponse}: the actual response
