...
class HttpBarExecutable implements Executable {
    ...
    @Override public void execute() throws IOException, InterruptedException {
        ...
        for (var interaction : interactions) {
            extension.beforeInteractionConsumers.forEach(consumer -> consumer.accept(interaction));
            ...
            extension.afterInteractionConsumers.forEach(consumer -> consumer.accept(interaction));
