...
/// An extension for [BDD assertj][BDDAssertions].
///
/// See also: [JsonValueAssert], [JsonValueAssert.JsonObjectAssert], [GraphQLClientExceptionAssert],
/// [HttpRequestAssert], [HttpResponseAssert]
