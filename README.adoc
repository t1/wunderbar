...
Releases are triggered by closing a milestone. They are pushed to Maven Central and added as a release in GitHub.

To limit confusion, the name of the milestone should normally match the version in the `pom.xml` (except for the `-SNAPSHOT` suffix).
