...
import com.github.t1.wunderbar.common.mock.GraphQLBodyMatcher.GraphQLBodyMatcherBuilder;
...
import static com.github.t1.wunderbar.common.mock.GraphQLResponseSupplier.graphQL;
import static com.github.t1.wunderbar.common.mock.GraphQLResponseSupplier.graphQlError;
import static com.github.t1.wunderbar.common.mock.MockUtils.productQuery;
...
public class MockService {
    ...
    static {
        ...
        addExpectation(productQuery("forbidden-product-id"),
        ...
        addExpectation(RequestMatcher.builder().path("/rest/products/forbidden-product-id").build(), restError()
            .status(403)
            .detail("HTTP 403 Forbidden")
            .title("ForbiddenException")
            .type("urn:problem-type:javax.ws.rs.ForbiddenException")
        );
        addExpectation(RequestMatcher.builder().path("/rest/products/unknown-product-id").build(), restError()
            .status(404)
    ...
    private static void addExpectation(HttpServletRequest request, String requestBody, HttpServletResponse response) {
        var variables = readJson(requestBody).asJsonObject().getJsonObject("variables");
